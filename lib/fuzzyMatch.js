...
export function wordFuzzyMatch(normalizedName, normalizedInput) {
  ...
  return words.some(word => {
    // 1. Exact prefix (original guard — kept for zero-cost short inputs)
    ...
    // 3. Prefix Levenshtein — for longer inputs where the user typed most of
    //    a long surname; only activate for inputs ≥ 4 chars to avoid noise.
